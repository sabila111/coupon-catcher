...
<div className="join join-vertical w-full">
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
            ...
            <div className="collapse-title text-xl font-medium"> What types of coupons are available?</div>
            <div className="collapse-content">
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
            <input type="radio" name="my-accordion-4" />
            <div className="collapse-title text-xl font-medium"> How can I use a discount coupon?</div>
            <div className="collapse-content">
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
            <input type="radio" name="my-accordion-4" />
            <div className="collapse-title text-xl font-medium"> Why can’t I access the coupon page?</div>
            <div className="collapse-content">
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
            <input type="radio" name="my-accordion-4" />
            <div className="collapse-title text-xl font-medium"> Are there any conditions for using coupons?</div>
            <div className="collapse-content">
