...
const BrandOnSell = ({brand}) => {
    ...
    return (
        <div className="card bg-base-100 w-[200px] md:w-[180px] lg:w-[300px] shadow-xl animate__animated animate__bounce animate__delay-2s">
  <figure>
  ...
  <div className="ml-4">
    ...
    <p className="font-normal lg:font-semibold text-gray-500 mb-1">Category: {category}</p>
